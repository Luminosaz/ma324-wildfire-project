...
- Model B (α=0.05, B=5): damage=95.1 → sim=10.7
- Model B (α=0.05, B=8): damage=87.4 → sim=4.6
- Baseline (no firebreaks): sim mean=17.4 (K=1000)
- Current corridor (row10, 17 cells): sim mean=1.6 (K=1000)
- Model A B=13 τ=0: sim mean=4.6 (K=1000)
- Model B B=16 α=0.05: sim mean=2.7 (K=1000)
...
- 两个模型都严重高估 damage（Model A: 80 vs sim 4.6, Model B α=0.05: 95 vs sim 10.7），但 plan 质量不错——model can predict poorly but produce a good plan
...
- Current corridor (17 cells) sim=1.6 其实比 MILP B=13 (sim=4.6) 还好，但 corridor 用了更多格子
